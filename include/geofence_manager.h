...
/**
 * @brief Called when some event occurs in geofence and place such as add, update, etc..
 * @details The events of public geofence is also received if there are public geofences.
 *
 * @since_tizen 2.4
 * @remarks The value of @a place_id or @a geofence_id is -1 when the place id or geofence id is not assigned.
 ...
 * @param[in] user_data The user data passed from callback registration function
 * @return @c true to continue iterating, otherwise @c false
